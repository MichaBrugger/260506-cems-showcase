...
- Google Calendar — use the "CEMS-Showcase" calendar (not the primary calendar) to check Andrew's availability
...
- `todos/` — task files by date. Check for existing tasks related to a person or thread. Create new tasks here when follow-ups are needed.
